...
# Замена модели на MobileNetV2
model = MobileNetV2(
    weights="imagenet",
)
model.compile(optimizer="adam", loss="categorical_crossentropy", metrics=["accuracy"])
model.save("mobilenetv2_img_final.h5")
model = keras.models.load_model("mobilenetv2_img_final.h5")
...
# end_time_tvm = time.time()
# inference_time_tvm = end_time_tvm - start_time_tvm
# print("Время инференса модели  opt TVM: {} секунд".format(inference_time_tvm))
# print ("FPS: ", countImg/inference_time_tvm)
...
work_dir = "meta-scheduler-mobilenetv2-keras-img" # Изменение имени work_dir
