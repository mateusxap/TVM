...
# Загрузка модели MobileNetV2 с весами, обученными на ImageNet
...
end_time_tvm = time.time()
inference_time_tvm = end_time_tvm - start_time_tvm
print("Время инференса модели TVM opt: {} секунд".format(inference_time_tvm))
print("FPS: ", countImg / inference_time_tvm)

# Мета-планировщик
work_dir = "meta-scheduler-torch-mobilenetv2-img"
